...
<body class="sub_page">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ url('About') }}">About <span
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <form action="" name="data-comment-bushefood">
                            <div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="pesan" name="pesan" rows="3" placeholder=
                                "Your Commant"></textarea>
                            </div>
    ...
    <script>
        const scriptURL =
            'https://script.google.com/macros/s/AKfycbxm9C8rCdJL6uazoBAWZx-RNFxD5moyMX65noZiQ2akRLStHGhCAB3gmfL3ZVnXdy6DKA/exec'
        const form = document.forms['data-comment-bushefood'];

        const btnkirim = document.querySelector('.btn_box');
